...
<ol class="breadcrumb">
  ...
  <li class="active">Atom Editor</li>
</ol>
  ...
  <h1>
    ...
    <div class="date-post-page">
      <i class="fa fa-calendar"></i> February 25, 2016
    </div>
    <hr>
  <div class="row">
...
<div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12">
      <h2>What is Atom Editor?</h2>
      <p><a href="http://atom.io/">Atom Editor</a> is a cross-platform code editor that is made by GitHub.</p>
      <h3>Cross-platform you say?</h3>
      <p>Yes, Atom is an application that can run on computer platforms/Operating System like Windows, Mac OS X and Linux distributions. I use Atom everyday to code, write documents and even to jot down notes for class or like a to do list. There are a lot of things that are great about Atom like the package manager, autocompletion, the file system browser and multiple panes.</p>
...
<div class="row container text-center">
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
    ...
    <p>You can easily open a single file or a whole project depending on what you are going to do with the editor at the time of using it. I love to use the editor to open a whole project so I can go back and forth to the pages that I need to code e.g. CSS and HTML or JavaScript.</p>
    ...
    <p>As I use the code editor daily I find more and more things that I love about it. Like I said before I use it on Mac and PC for doing web design work across computers, depending on the work.</p>
