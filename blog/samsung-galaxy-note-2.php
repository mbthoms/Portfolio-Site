...
<ol class="breadcrumb">
  ...
  <li class="active">Samsung Galaxy Note 2</li>
</ol>
  ...
  <h1>
    ...
    Samsung Galaxy Note 2</h1>
    <div class="date-post-page">
      <i class="fa fa-calendar"></i> July 12, 2015
    </div>
    <hr>
<div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12">
      ...
      <ul>
        ...
        <li>Samsung In-ear earphones with remote.</li>
        <li>USB to Micro USB Cable</li>
        <li>USB to WallPlug (adapter)</li>
        <li>User Manual</li>
        <li>Warranty Information</li>
        <li>Standard Li-ion 3,100 mAh battery</li>
      </ul>
      <h3>Camera</h3>
      <p>
