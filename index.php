  ...
  <section id="slider">
    <div id="home-carousel" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(images/slider/01.jpg); background-position: bottom">
          <div class="carousel-caption container">
            <div class="row">
              <div class="col-sm-7">
                <h1>#Creative<strong>Websites</strong></h1>
                <h2>interesting designs</h2>
              </div>
            </div>
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/02.jpg); background-position: center">
          <div class="carousel-caption container">
            <div class="row">
              <div class="col-sm-7">
                <h1>#<strong>SEO</strong>Optimization</h1>
                <h2>helps people find your business.</h2>
              </div>
            </div>
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/03.jpg); background-position: center">
          <div class="carousel-caption container">
            <div class="row">
              <div class="col-sm-7">
                <h1>#Developing<strong>Websites</strong></h1>
                <h2>is my passion.</h2>
              </div>
            </div>
          </div>
